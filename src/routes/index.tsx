      ...
      <section id="top" className="noise relative flex min-h-[105svh] items-center pt-28">
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-16 px-6 py-20 lg:grid-cols-[1.08fr_.92fr] lg:px-8">
          <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .9 }}>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4"><MagneticButton variant="hero" size="xl" onClick={goSignup}>Start building your brand <ArrowRight /></MagneticButton><MagneticButton variant="glass" size="xl" onClick={() => setWatchDemoOpen(true)}><CirclePlay /> Watch live demo</MagneticButton><Button variant="ghost" size="lg" onClick={() => setWaitlistOpen(true)}>Join waitlist</Button></div>
